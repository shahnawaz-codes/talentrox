...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-base-100 to-base-200">
      ...
      {/* MOBILE MENU */}
      {isMobileMenuOpen && (
        <div className="fixed top-20 left-1/2 -translate-x-1/2 z-40 w-[90%] max-w-6xl rounded-3xl shadow-xl p-6 md:hidden backdrop-blur-md bg-base-100/95 animate-slideDown border border-primary/20">
      ...
      <div className="max-w-7xl mx-auto px-6 py-24 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8 animate-[fadeInUp_0.8s_ease-out]">
            {/* BADGE */}
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/20 rounded-full animate-[scaleIn_0.6s_ease-out]">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight text-base-content">
                Ace Your Technical
                <span className="block text-primary mt-2 animate-[slideInLeft_0.8s_ease-out]">
                  Interviews Together
                </span>
              </h1>
              
              <p className="text-lg text-base-content/70 leading-relaxed max-w-xl animate-[fadeIn_1s_ease-out_0.3s_both]">
                Experience seamless coding interviews with real-time collaboration, 
                HD video calls, and an advanced code editor. Everything you need to 
                succeed in one platform.
              </p>
            </div>

            {/* CTA BUTTONS */}
            <div className="flex flex-col sm:flex-row gap-4 animate-[fadeIn_1s_ease-out_0.5s_both]">
              <SignInButton mode="modal">
            ...
            {/* TRUST INDICATORS */}
            <div className="flex flex-wrap items-center gap-6 pt-4 animate-[fadeIn_1s_ease-out_0.7s_both]">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-base-content/60">Join 10K+ users</span>
              </div>
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="text-sm text-base-content/60 ml-2">4.9/5 rating</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative animate-[fadeInUp_0.8s_ease-out_0.3s_both]">
            ...
            <div className="relative bg-base-100 rounded-2xl shadow-2xl border border-base-300 p-6 hover:scale-105 transition-transform duration-500">
              <img
                src="/images/hero.png"
                alt="TalentIQ Platform Interface"
                className="w-full h-auto rounded-xl"
              />
              {/* Floating elements */}
              <div className="absolute -top-4 -left-4 bg-success text-success-content px-4 py-2 rounded-lg shadow-lg text-sm font-semibold animate-[bounce_2s_ease-in-out_infinite]">
                ✓ Live Interview
              </div>
              <div className="absolute -bottom-4 -right-4 bg-primary text-primary-content px-4 py-2 rounded-lg shadow-lg text-sm font-semibold flex items-center gap-2 animate-[bounce_2s_ease-in-out_0.5s_infinite]">
      ...
      <div ref={statsRef} className="bg-base-100 border-y border-base-300">
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className={`text-center transition-all duration-700 delay-100 ${statsInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <div className="text-3xl lg:text-4xl font-bold text-secondary mb-2">
                {interviews}K+
              </div>
              <div className="text-sm text-base-content/60">Interviews Completed</div>
            </div>
            <div className={`text-center transition-all duration-700 delay-200 ${statsInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <div className="text-3xl lg:text-4xl font-bold text-accent mb-2">
                {uptime.toFixed(1)}%
              </div>
              <div className="text-sm text-base-content/60">Uptime SLA</div>
            </div>
            <div className={`text-center transition-all duration-700 delay-300 ${statsInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      ...
      {/* FEATURES SECTION */}
      <div ref={featuresRef} className="max-w-7xl mx-auto px-6 py-20" id="features">
        <div className={`text-center mb-16 transition-all duration-700 ${featuresInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className="text-lg text-base-content/60 max-w-2xl mx-auto">
            Powerful tools designed to make technical interviews seamless and productive
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            { icon: Video, color: "primary", title: "HD Video Calling", desc: "Crystal clear video and audio quality with zero lag for seamless face-to-face interviews", badges: ["WebRTC", "1080p"], delay: 0 },
            { icon: Code2, color: "secondary", title: "Live Code Editor", desc: "Real-time collaborative editing with syntax highlighting for 50+ programming languages", badges: ["50+ Languages", "Auto-save"], delay: 100 },
            { icon: Users, color: "accent", title: "Real-Time Collaboration", desc: "Work together seamlessly with instant sync, cursor tracking, and live feedback", badges: ["Instant Sync", "Multi-user"], delay: 200 },
            { icon: ShieldCheck, color: "success", title: "Secure & Private", desc: "Enterprise-grade security with end-to-end encryption and secure data handling", badges: ["Encrypted", "GDPR"], delay: 300 },
            { icon: Clock, color: "warning", title: "Session Recording", desc: "Record and playback interviews for review and feedback with timestamp controls", badges: ["Auto-record", "Playback"], delay: 400 },
            { icon: TrendingUp, color: "info", title: "Analytics Dashboard", desc: "Track performance metrics, interview history, and improvement areas", badges: ["Metrics", "Reports"], delay: 500 }
          ].map((feature, index) => {
            ...
            return (
              ...
              >
                <div className="card-body">
                  <div className={`size-12 bg-gradient-to-br from-${feature.color}/20 to-${feature.color}/10 rounded-xl flex items-center justify-center mb-4`}>
                  ...
                  <div className="card-actions mt-4">
                    {feature.badges.map((badge, i) => (
                      <div key={i} className={`badge badge-${feature.color} badge-sm badge-outline`}>{badge}</div>
                    ))}
                  </div>
                </div>
              </div>
      ...
      {/* CTA SECTION */}
      <div ref={ctaRef} className={`bg-gradient-to-r from-primary to-secondary transition-all duration-700 ${ctaInView ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
        <div className="max-w-7xl mx-auto px-6 py-16 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">
            Ready to Transform Your Interview Experience?
          </h2>
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            Join thousands of professionals who trust TalentIQ for their technical interviews
          </p>
          <SignInButton mode="modal">
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-base-content/60">
              © 2024 TalentIQ. All rights reserved.
            </p>
            <div className="flex gap-6">
              <a href="#" className="text-sm text-base-content/60 hover:text-primary transition-colors">Privacy</a>
              <a href="#" className="text-sm text-base-content/60 hover:text-primary transition-colors">Terms</a>
